...
public class ContainerAction4 implements PacketType {
	...
	public void processPacket(Player c, int packetType, int packetSize) {
		...
		if (c.getBank().withdrawFromSlot(interfaceId, removeId, removeSlot,Integer.MAX_VALUE)) {
			return;
		}
		...
		case 5064:
			...
			if (c.isBanking) {
				c.getItems().addToBankFromSlot(removeSlot, removeId, c.getItems().getItemAmount(removeId), true, false);
			} else {
				GroupIronmanBank.processContainerAction(c, action);
			}
			break;
