...
public class AttackEntity {
    ...
    public void attackEntity(Entity targetEntity) {
        ...
        // Wrath finisher arming: re-clicking your current target at 80+ Wrath will arm your finisher.
        // This must run even when your attackTimer is still active (i.e., during an ongoing fight),
        // so we do it early in the flow.
    //    WrathSystem.onAttackCommand(attacker, targetEntity);
        ...
        if (targetEntity.isPlayer()) {
            ...
            targetPlayer.refreshCombatState();
