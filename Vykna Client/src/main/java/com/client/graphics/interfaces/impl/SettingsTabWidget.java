...
public class SettingsTabWidget extends RSInterface {
    ...
    try {
        com.client.features.settings.Preferences p = com.client.features.settings.Preferences.getPreferences();
        if (RSInterface.interfaceCache[MUSIC_SLIDER] != null && RSInterface.interfaceCache[MUSIC_SLIDER].slider != null) {
            RSInterface.interfaceCache[MUSIC_SLIDER].slider.setValue(10 - (int)p.musicVolume);
        }
        if (RSInterface.interfaceCache[SOUND_SLIDER] != null && RSInterface.interfaceCache[SOUND_SLIDER].slider != null) {
            RSInterface.interfaceCache[SOUND_SLIDER].slider.setValue(10 - (int)p.soundVolume);
        }
        if (RSInterface.interfaceCache[AREA_SOUND_SLIDER] != null && RSInterface.interfaceCache[AREA_SOUND_SLIDER].slider != null) {
            RSInterface.interfaceCache[AREA_SOUND_SLIDER].slider.setValue(10 - (int)p.areaSoundVolume);
        }
    } catch (Throwable t) {
        // never crash over settings refresh
    }
}
