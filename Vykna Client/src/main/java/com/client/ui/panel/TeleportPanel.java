...
public class TeleportPanel extends WidgetPanel {
	public TeleportPanel(int id, Rectangle bounds) {
		super(id, bounds);
	}
	...
	public void draw(Client client) {
		...
		client.drawTeleportButtonAt(bounds.x, bounds.y);
	}

	@Override
	public boolean handleMouse(Client client, int mouseX, int mouseY) {
		client.setTeleOrbHover(true);
