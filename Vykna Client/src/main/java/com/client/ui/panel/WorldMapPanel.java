...
public class WorldMapPanel extends WidgetPanel {
	public WorldMapPanel(int id, Rectangle bounds) {
		super(id, bounds);
	}
	...
	public void draw(Client client) {
		...
		client.drawWorldMapButtonAt(bounds.x, bounds.y);
	}

	@Override
	public boolean handleMouse(Client client, int mouseX, int mouseY) {
		client.setWorldHover(true);
