...
public class Entity extends Renderable {
	...
	public int pressure = 0;           // 0..100 (real value later)
	public int pressureDisplayed = 0;  // 0..100 (smoothed display)

	public void updatePressureSmoothing() {
		int diff = pressure - pressureDisplayed;
		if (diff != 0) {
			pressureDisplayed += Math.max(-4, Math.min(4, diff));
		}
	}
